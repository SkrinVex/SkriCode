...
object SimEngine {
    ...
    private suspend fun runScriptOnState(
        ...
        // Отслеживаем дифф: что скрипт явно удалил и какие поля изменил
        ...
        // 2. Применяем изменения/создания скрипта, сохраняя актуальную физику/координаты если скрипт их не менял
