...
object BlockRegistry {
    ...
    private val types = listOf(
        ...
        "sim_create", "sim_move", "sim_resize", "sim_color", "sim_bg_color", "sim_text", "sim_update_text", "sim_button", "sim_text_input", "sim_clear_focus",
        "sim_hide", "sim_show", "sim_alpha", "sim_touch_disable", "sim_touch_enable", "sim_rotate", "sim_joystick", "sim_modify", "sim_delete", "sim_layer",
        "set_texture", "sim_sprite", "anim_play", "anim_stop", "anim_set_frame",
        "sim_physics", "sim_hitbox", "physics_toggle",
        "physics_impulse", "physics_move", "sim_no_collision", "sim_restore_collision",
        "particle_burst", "particle_emitter", "particle_emitter_stop",
        "sim_camera", "camera_toggle", "camera_zoom", "camera_bounds", "screen_shake", "screen_flash",
